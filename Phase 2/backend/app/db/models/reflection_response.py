...
class ReflectionResponse(Base):
    """Reflection submitted after a human decision is made."""

    __tablename__ = "reflection_responses"
    __table_args__ = (
        Index("ix_reflection_responses_session_id", "session_id"),
        Index("ix_reflection_responses_step_id", "step_id"),
    )

    reflection_response_id: Mapped[str] = mapped_column(
